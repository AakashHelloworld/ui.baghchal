...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col justify-end p-4 bg-[url(/BaghChal.jpg)] bg-no-repeat bg-center bg-cover relative overflow-hidden scroll-hidden">
      ...
      <div className="flex flex-col self items-center justify-center space-y-1">
      <Link href="/game">
      <button
        className="w-[20rem]  h-[8rem] text-[#000] text-[2rem] translate-x-8 translate-y-4 text-2xl p-3 rounded-full active:scale-90 transition-all bg-[url(/wooden.png)] bg-center bg-cover  hover:translate-y-2"
      ...
      {/* <button
        className="w-[26rem] h-[8rem] text-[#000] text-[2rem] translate-x-8 translate-y-4 text-2xl p-3 rounded-full active:scale-90 transition-all bg-[url(/wooden.png)] bg-center bg-cover  hover:translate-y-2"
